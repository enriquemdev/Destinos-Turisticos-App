...
class DestinationMap extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Determine bounds when POIs are present so all markers are visible
          ...
          children: [
            ...
            MarkerLayer(
              markers: [
                ...
                // Primary marker — the destination itself (rendered last = on top)
                Marker(
                  point: mainPoint,
                  width: 48,
                  height: 48,
