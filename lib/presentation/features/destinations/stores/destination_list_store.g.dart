...
mixin _$DestinationListStore on DestinationListStoreBase, Store {
  ...
  Computed<List<DestinationDto>>? _$displayedDestinationsComputed;

  @override
  List<DestinationDto> get displayedDestinations =>
      (_$displayedDestinationsComputed ??= Computed<List<DestinationDto>>(
  ...
  @override
  ObservableList<DestinationDto> get destinations {
    _$destinationsAtom.reportRead();
    return super.destinations;
  }

  @override
  set destinations(ObservableList<DestinationDto> value) {
